            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="md:w-1/3 bg-nature-5 p-5 rounded-lg shadow-lg mt-10 md:mt-0">
                    ...
                    <?php if(session('success')): ?>
                        <div class="bg-green-500 text-white p-3 rounded-md mb-4 text-center"><?php echo e(session('success')); ?></div>
                    <?php endif; ?>
                    ...
                    <form action="<?php echo e(route('callback.store')); ?>" method="POST" class="bg-white p-6 shadow-lg rounded-lg">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-nature-1 text-black" required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-black font-semibold mb-2">Your Email</label>
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-nature-1 text-black" required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-black font-semibold mb-2">Contact No</label>
                            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-nature-3 text-black" required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-black font-semibold mb-2">Purpose Of Contact</label>
                            <input type="text" name="purpose" value="<?php echo e(old('purpose')); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-nature-3 text-black" required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-black font-semibold mb-2">Your Message</label>
                            <textarea name="message" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-nature-3 text-black" required><?php echo e(old('message')); ?></textarea>
                        </div>
...
<form action="<?php echo e(route('quote.store')); ?>" method="POST" class="space-y-4">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="w-full">
            <input type="email" name="email" placeholder="Your Email" value="<?php echo e(old('email')); ?>"
                class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-400 bg-white"
                required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        <input type="text" name="phone" placeholder="Contact No" value="<?php echo e(old('phone')); ?>"
            class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-400 bg-white"
            required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        <input type="text" name="purpose" placeholder="Purpose Of Contact" value="<?php echo e(old('purpose')); ?>"
            class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-400 bg-white"
            required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\services-app\resources\views/home.blade.php ENDPATH**/ ?>