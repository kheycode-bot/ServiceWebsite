        ...
        <ul class="nav-links flex-grow flex justify-center space-x-6 text-lg" style="font-family: 'Poppins', sans-serif;">
            <li>
                <a href="<?php echo e(route('home')); ?>" 
                   class="text-nature-1 hover:text-nature-3 <?php echo e(request()->routeIs('home') ? 'font-bold border-b-2 border-nature-3' : ''); ?>">
                   Home
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('about')); ?>" 
                   class="text-nature-1 hover:text-nature-3 <?php echo e(request()->routeIs('about') ? 'font-bold border-b-2 border-nature-3' : ''); ?>">
                   About Us
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('services')); ?>" 
                   class="text-nature-1 hover:text-nature-3 <?php echo e(request()->routeIs('services') ? 'font-bold border-b-2 border-nature-3' : ''); ?>">
                   Services
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('faq')); ?>" 
                   class="text-nature-1 hover:text-nature-3 <?php echo e(request()->routeIs('faq') ? 'font-bold border-b-2 border-nature-3' : ''); ?>">
                   FAQ
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('contact')); ?>" 
                   class="text-nature-1 hover:text-nature-3 <?php echo e(request()->routeIs('contact') ? 'font-bold border-b-2 border-nature-3' : ''); ?>">
                   Contact
                </a>
            </li>
        </ul>
...
<?php /**PATH C:\xampp\htdocs\services-app\resources\views/components/navbar.blade.php ENDPATH**/ ?>